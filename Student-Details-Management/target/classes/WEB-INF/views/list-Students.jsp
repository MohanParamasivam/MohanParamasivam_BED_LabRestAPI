...
<body>
	...
	<div class="container">
		...
		<div class="d-flex justify-content-around">
			...
			<!-- Adding buttons -->
			<a 	href="/StudentDetailsManagement/students/showFormForAdd"
				class="btn btn-primary btn-sm mb-3 mx-auto"> Add Student </a> 
				
			<a	href="/StudentDetailsManagement/students/printAllStudents"
				class="btn btn-primary btn-sm mb-3 mx-auto"> Print All Students </a> 
				
			<a	href="/StudentDetailsManagement/logout"
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/StudentDetailsManagement/students/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-primary btn-sm"> Update </a> <!-- Add "delete" button/link -->

							<!-- Add "delete" button/link --> <a
							href="/StudentDetailsManagement/students/delete?studentId=${tempStudent.id}"
							class="btn btn-danger btn-sm"
							onclick="if (!(confirm('Are you sure you want to delete this student?'))) return false">Delete</a>

							<!-- Add "view" button/link --> <a
							href="/StudentDetailsManagement/students/viewStudent?studentId=${tempStudent.id}"
